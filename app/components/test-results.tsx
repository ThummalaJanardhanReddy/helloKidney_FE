...
const TestResults = () => {
  ...
  const formattedReports = [parsedResult]?.map((item) => {
    ...
    return {
      ...
      patientCreatedDate: patientdetails?.created_on ? formatDate(patientdetails?.created_on) : "N/A",
...
Generated by HelloKidney App
  ...
  return (
    <SafeAreaView style={styles.container}>
      <StatusBar backgroundColor={colors.bg_home} animated style="light"/>
      {/* Header */}
